...
class PrtrFeatureExtractionTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=7,
    ...
    def get_expected_values(self, image_inputs, batched=False):
        """
        This function computes the expected height and width when providing images to PrtrFeatureExtractor,
...
@require_torch
@require_vision
class PrtrFeatureExtractionTest(FeatureExtractionSavingTestMixin, unittest.TestCase):

    feature_extraction_class = PrtrFeatureExtractor if is_vision_available() else None

    def setUp(self):
        self.feature_extract_tester = PrtrFeatureExtractionTester(self)
    ...
    def test_call_pytorch_with_coco_detection_annotations(self):
        ...
        # encode them
        feature_extractor = PrtrFeatureExtractor.from_pretrained("anugunj/prtr-hrtnet-coco")
    ...
    def test_call_pytorch_with_coco_panoptic_annotations(self):
        ...
        # encode them
        # TODO replace by .from_pretrained anugunj/prtr-hrtnet-coco-panoptic
        feature_extractor = PrtrFeatureExtractor(format="coco_panoptic")

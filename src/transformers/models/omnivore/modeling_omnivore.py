...
class OmnivoreJointClassificationOutput(ModelOutput):
    ...
    Args:
        ...
        hidden_states (`tuple(torch.FloatTensor)`, *optional*, returned when `output_hidden_states=True` is passed or when `config.output_hidden_states=True`):
            Tuple of `torch.FloatTensor` (one for the output of each layer of `OmnivoreSwinTransformer3DLayer`) of
...
class OmnivoreForJointClassification(OmnivorePreTrainedModel):
    ...
    def forward(
        ...
        image_logits, video_logits, rgbd_logits = None, None, None
        ...
        image_loss, video_loss, rgbd_loss = None, None, None
        ...
        if not return_dict:
            ...
            return ((image_loss, video_loss, rgbd_loss) + output) if image_loss or video_loss or rgbd_loss else output
